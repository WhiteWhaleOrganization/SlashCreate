...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MZRaise/MZRaise.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Moya/Moya.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NVActivityIndicatorView/NVActivityIndicatorView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RZColorfulSwift/RZColorfulSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SnapKit/SnapKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SpeechBell/SpeechBell.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyJSON/SwiftyJSON.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WKToast/WKToast.framework"
fi
